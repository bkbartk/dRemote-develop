...
Namespace Forms.OptionsPages
    Public Class ConnectionsPage
        ...
        Public Overrides Sub LoadSettings()
            ...
            txtCredentialsPassword.Text = Crypt.DecryptStringFromBytes_Aes(My.Settings.DefaultPassword, General.EncryptionKeyAES)
        ...
        Public Overrides Sub SaveSettings()
            ...
            My.Settings.DefaultPassword = Crypt.EncryptStringToBytes_Aes(txtCredentialsPassword.Text, General.EncryptionKeyAES)
