...
Namespace Forms.OptionsPages
    Public Class SqlServerPage
        ...
        Public Overrides Sub LoadSettings()
            ...
            txtSQLPassword.Text = Crypt.DecryptStringFromBytes_Aes(My.Settings.SQLPass, General.EncryptionKeyAES)
        End Sub
        ...
        Public Overrides Sub SaveSettings()
            ...
            My.Settings.SQLPass = Crypt.Encrypt(txtSQLPassword.Text, General.EncryptionKeyAES)
