...
#Region "Connections Loading/Saving"
        ...
        Public Shared Sub LoadConnections(Optional ByVal withDialog As Boolean = False, Optional ByVal update As Boolean = False, Optional ByRef tvConnections As TreeView = Nothing)
            ...
            Try
                ...
                connectionsLoad.SQLPassword = Security.Crypt.DecryptStringFromBytes_Aes(My.Settings.SQLPass, Info.General.EncryptionKeyAES)
        ...
        Public Shared Sub SaveConnections(Optional ByVal Update As Boolean = False)
            ...
            Try
                ...
                If My.Settings.UseSQLServer = True Then
                    ...
                    conS.SQLPassword = Security.Crypt.DecryptStringFromBytes_Aes(My.Settings.SQLPass, App.Info.General.EncryptionKeyAES)
                End If
...
#Region "Event Handlers"
        ...
        'Public Shared Sub Prot_Event_FormClosing(ByVal sender As Object, e As FormClosingEventArgs)
        '    sender.Select()
        'End Sub
