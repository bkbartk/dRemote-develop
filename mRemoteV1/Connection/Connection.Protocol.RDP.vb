...
#Region "Private Declarations"
            Private _rdpClient As MsRdpClientNotSafeForScripting
...
#Region "Public Methods"
            Public Sub New()
                Control = New AxMsRdpClientNotSafeForScripting
            End Sub
            ...
            Public Overrides Function SetProps() As Boolean
                ...
                Try
                    ...
                    Try
                        ...
                        _rdpClient = CType(Control, AxMsRdpClientNotSafeForScripting).GetOcx()
                        ...
                        Select Case My.Settings.EmptyCredentials
                            Case "custom"
                                If My.Settings.DefaultPassword <> "" Then
                                    _rdpClient.AdvancedSettings2.ClearTextPassword = Security.Crypt.DecryptStringFromBytes_Aes(My.Settings.DefaultPassword, App.Info.General.EncryptionKeyAES)
                                End If
                        End Select
                    Else
