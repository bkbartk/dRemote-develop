            ...
            Public Overrides Function Connect() As Boolean
                Try
                    ...
                    With PuttyProcess.StartInfo
                            ...
                            If _PuttyProtocol = Putty_Protocol.ssh Then
                                ...
                                Else
                                    If My.Settings.EmptyCredentials = "custom" Then
                                        password = Security.Crypt.DecryptStringFromBytes_Aes(My.Settings.DefaultPassword, App.Info.General.EncryptionKeyAES)
                                    End If
                                End If
                        ...
                        End If
                        Dim args As String = arguments.ToString
                        If Not String.IsNullOrEmpty(My.Settings.ExtraPuttyParameters.Trim) Then
                            args = " " + My.Settings.ExtraPuttyParameters.Trim + " " + args
                        End If
                        .Arguments = args
                    End With
